...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 22 2020 г., 10:55
...
CREATE TABLE `classes` (
  `id` int NOT NULL,
  `name` varchar(15) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Class'
...
CREATE TABLE `results` (
  ...
  `test_id` int NOT NULL COMMENT 'Test',
...
(2, 4, 1, '00:00:42', '20.00'),
(3, 1, 1, '00:01:24', '60.00'),
(4, 2, 1, '00:00:24', '20.00'),
(5, 1, 1, '00:00:35', '0.00'),
(6, 3, 1, '00:00:32', '40.00'),
(7, 5, 1, '00:00:08', '20.00'),
(8, 5, 2, '00:00:35', '25.00'),
(9, 3, 1, '00:02:00', '55.00');
...
CREATE TABLE `students` (
  `id` int NOT NULL,
  `class_id` int NOT NULL COMMENT 'Class',
...
(1, 1, 'English vocabulary', 150, 'Я', '2020-07-20 13:35:33'),
